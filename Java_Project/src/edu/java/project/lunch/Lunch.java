...
public class Lunch extends JFrame {
	 ...
	 */
	public static void showLunch(Component parent) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Lunch frame = new Lunch(parent);
	...
	private void addBreakfast() {
		...
		LunchTable breakfastTable = new LunchTable (fid, day, diary, lunchkcal);
