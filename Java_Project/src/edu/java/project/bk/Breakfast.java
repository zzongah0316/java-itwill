...
public class Breakfast extends JFrame {
	...
	private void loadBktData() {
		...
		for(BreakfastTable s : breakfastTableList) {
			System.out.println("breakfastTableList : "+ s);
		}
	...
	protected void updateBreakf() {
		...
		int cid = breakfastTableList.get(row).getFid();
		BreakfastUpdate.showBreakfastUpdate(contentPane, cid, Breakfast.this);
