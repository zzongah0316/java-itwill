...
public class Product {
	...
	public Product (int productId, String productName) {
		...
		this.productName = productName; // this(productId, productName, 0); 둘 다 상관X / this -> 다른 생성자.
	}

	// 메서드:
	// (1) printProductInfo: 상품의 모든 정보를 콘솔에 출력
	public void printProductInfo() {
		System.out.printf("상품 아이디: %d, 상품 이름: %s, 상품 가격: %d\n",
				this.productId, this.productName, productPrice);
